...
export const metadata: Metadata = {
  title: "Contact",
  description: "Contact Shiham Ahamed about software engineering opportunities and practical project work.",
...
export default async function ContactPage() {
  ...
  ].filter((method) => Boolean(method.value && method.href));
        ...
        <div className="grid gap-6 lg:grid-cols-12 lg:items-start lg:gap-8">
          ...
          >
            {contactMethods.length > 0 ? (
              ...
              <StaggerItem>
                <p className="rounded-2xl border border-border/60 bg-background/60 p-5 text-sm leading-7 text-muted-foreground shadow-sm">
                  Contact details will appear here after they are configured.
                </p>
              </StaggerItem>
            )}
          </StaggerContainer>
