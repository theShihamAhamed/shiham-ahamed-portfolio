...
const fallbackHero = {
  ...
  description:
    "I build production-minded full-stack applications with clean architecture, thoughtful interfaces, and practical backend depth.",
};
...
const HeroSection = async () => {
  const { hero, profile } = await getHeroData();
