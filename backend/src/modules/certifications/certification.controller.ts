...
const revalidateCertificationCache = (context: string) => {
  void revalidatePublicCache([PUBLIC_CACHE_TAGS.certifications], context);
};
...
export const createAdminCertification = asyncHandler(async (req, res) => {
  ...
  revalidateCertificationCache("certification create");
...
export const updateAdminCertification = asyncHandler(async (req, res) => {
  ...
  revalidateCertificationCache("certification update");
...
export const deleteAdminCertification = asyncHandler(async (req, res) => {
  ...
  revalidateCertificationCache("certification delete");
...
export const replaceAdminCertificationImage = asyncHandler(async (req, res) => {
  ...
  revalidateCertificationCache("certification image replacement");
...
export const updateCertificationVisibility = asyncHandler(async (req, res) => {
  ...
  revalidateCertificationCache("certification visibility update");
...
export const reorderAdminCertifications = asyncHandler(async (req, res) => {
  ...
  revalidateCertificationCache("certification reorder");
