...
const revalidateCurrentlyBuildingCache = (context: string) => {
  void revalidatePublicCache([PUBLIC_CACHE_TAGS.currentlyBuilding], context);
};
...
export const createAdminCurrentlyBuildingItem = asyncHandler(
  async (req, res) => {
    ...
    revalidateCurrentlyBuildingCache("currently-building create");
...
export const updateAdminCurrentlyBuildingItem = asyncHandler(
  async (req, res) => {
    ...
    revalidateCurrentlyBuildingCache("currently-building update");
...
export const deleteAdminCurrentlyBuildingItem = asyncHandler(
  async (req, res) => {
    ...
    revalidateCurrentlyBuildingCache("currently-building delete");
...
export const updateCurrentlyBuildingVisibility = asyncHandler(
  async (req, res) => {
    ...
    revalidateCurrentlyBuildingCache("currently-building visibility update");
...
export const reorderAdminCurrentlyBuildingItems = asyncHandler(
  async (req, res) => {
    ...
    revalidateCurrentlyBuildingCache("currently-building reorder");
